...
export const MobileNav: React.FC<MobileNavType> = ({showMobileNavbar, setShowMobileNavbar}) => {
    return (
        <div className={"backdrop py-[12px] bg-opacity-95 text-white backdrop-blur-lg bg-black z-50 fixed w-full min-h-screen"}>
            ...
            <div className={"mt-14"}>
                <div className={"mx-20"}>
                    <TopBarCard hideIcon icon={icon1} name={"Connect Wallet"} borderColor={"#ffffff"} textColor={"#000000"}
                                ...
                                className={"font-bold text-black px-5 py-2 font-semibold"}/>
                </div>

                <div className={"mx-4"}>
                    <div className={"bg-[#1a1a1a] py-3 px-3.5 space-y-4 rounded-3xl text-xs my-7"}>
                ...
                <div className={"flex justify-center flex-col items-center space-y-4"}>
                    ...
                    <div className={"bg-[#1a1a1a] w-fit flex items-center p-1.5 gap-1 rounded-3xl text-xs"}>
                        <Twitter className={"bg-black p-2 rounded-3xl h-10 w-24 hover:cursor-pointer hover:text-yellow-400"}/>
                        <Instagram className={"bg-black p-2 rounded-3xl h-10 w-24 hover:cursor-pointer hover:text-yellow-400"}/>
                    </div>
                </div>
            </div>
        </div>
