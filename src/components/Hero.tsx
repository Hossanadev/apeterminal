  ...
  return (
    <section className={"relative pt-12 bg-black flex justify-center items-center overflow-hidden"}>
        ...
        <div
            ...
            <p className={"text-6xl lg:text-7xl xl:text-8xl text-black font-semibold transition-all duration-500"}>Ape, <br /> Launch</p>
            <p className={"text-[14px] lg:text-[20px] xl-text-[24px] font-normal text-black"}>
        ...
        <Image src={backgroundPPLImg} alt={"backgroundImg"} className={"absolute w-full top-20 z-30 object-cover hero_anim hidden md:block"}/>
    </section>
  )
};
